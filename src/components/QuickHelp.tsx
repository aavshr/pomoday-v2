...
const QUICK_HELP_TEXT = [
  "<p style='margin: 5px 0;'>Welcome to Pomoday, a keyboard-only task management application that help you be more productive!</p><p style='margin: 5px 0;'>Let's get started!</p>",
